...
class PeriodosControllerTest < ActionController::TestCase
  ...
  test "should create periodo" do
    assert_difference('Periodo.count') do
      post :create, periodo: { matricula_fim: @periodo.matricula_fim, matricula_inicio: @periodo.matricula_inicio, reajuste: @periodo.reajuste, reajuste_inicio: @periodo.reajuste_inicio }
    end
  ...
  test "should update periodo" do
    put :update, id: @periodo, periodo: { matricula_fim: @periodo.matricula_fim, matricula_inicio: @periodo.matricula_inicio, reajuste: @periodo.reajuste, reajuste_inicio: @periodo.reajuste_inicio }
    assert_redirected_to periodo_path(assigns(:periodo))
  end
